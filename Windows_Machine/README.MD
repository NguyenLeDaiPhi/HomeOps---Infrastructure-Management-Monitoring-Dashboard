...
An infrastructure monitoring platform designed for real-time telemetry streaming between a **Kali Linux Virtual Machine (192.168.2.2)** and a **Windows Host Machine (0.0.0.0)** over host-only networking.
